...
class paths:
    raw_amass_dir = '/home/danielamrhein/master_thesis/data/AMASS_raw'      # raw AMASS dataset path (raw_amass_dir/ACCAD/ACCAD/s001/*.npz)
    amass_dir = '/home/danielamrhein/master_thesis/data/processed_data/AMASS_syn'         # output path for the synthetic AMASS dataset

    raw_dipimu_dir = '/home/danielamrhein/master_thesis/data/DIP_IMU'   # raw DIP-IMU dataset path (raw_dipimu_dir/s_01/*.pkl)
    dipimu_dir = '/home/danielamrhein/master_thesis/data/processed_data/DIP_IMU'      # output path for the preprocessed DIP-IMU dataset

    raw_uwbimu_dir = '/local/shared_data/data_UWB_IMU/SIGGRAPH_dataset'   # raw UWB IMU dataset path
    uwbimu_dir = '/home/danielamrhein/master_thesis/data/processed_data/UWB_IMU/SIGGRAPH_dataset'      # output path for the preprocessed UWB IMU dataset

    # DIP recalculates the SMPL poses for TotalCapture dataset. You should acquire the pose data from the DIP authors.
    raw_totalcapture_dip_dir = '/home/danielamrhein/master_thesis/data/TotalCapture_Real_60FPS'  # contain ground-truth SMPL pose (*.pkl)
    raw_totalcapture_official_dir = '/home/danielamrhein/master_thesis/data/TotalCapture'    # contain official gt (S1/acting1/gt_skel_gbl_pos.txt)
    totalcapture_dir = '/home/danielamrhein/master_thesis/data/processed_data/TotalCapture'          # output path for the preprocessed TotalCapture dataset

    result_dir = '/home/danielamrhein/master_thesis/data/result'                      # output directory for the evaluation results

    smpl_file = '/home/danielamrhein/master_thesis/data/basicModel_m_lbs_10_207_0_v1.0.0.pkl'     # official SMPL model path
    physics_model_file = '/home/danielamrhein/master_thesis/data/urdfmodels/physics.urdf'      # physics body model path
    plane_file = '/home/danielamrhein/master_thesis/data/urdfmodels/plane.urdf'                # (for debug) path to plane.urdf    Please put plane.obj next to it.
    weights_file = '/home/danielamrhein/master_thesis/data/weights.pt'                # network weight file
